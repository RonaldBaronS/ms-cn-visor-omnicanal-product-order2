package com.tdp.ms.productorder.ms.model;
...
@NoArgsConstructor
@ToString
public class ProductRiOrderResponse {
    ...
    */
    ...
    /**
     * Metodo que realizar el mapeo del response al dto.
     * @author Ronald Baron
     * @version 1.0
     */
     public static List<ProductOrderDto> mapper(List<ProductRiOrderResponse> productRiConsultarResponseList){
         
         List<ProductOrderDto> productOrderDtoList = null;
         
         if (Utilitarios.validarListaNotEmpty(productOrderDtoList)) {
             productOrderDtoList = new ArrayList<ProductOrderDto>();
             
             for (ProductRiOrderResponse productRiConsultarResponse  : productRiConsultarResponseList) {
                 ProductOrderDto  orderDto = new ProductOrderDto();
                 
                 orderDto.setId(productRiConsultarResponse.getId());
                 orderDto.setHref(productRiConsultarResponse.getHref());
                 orderDto.setCorrelationId(productRiConsultarResponse.getCorrelationId());
                 
                 productOrderDtoList.add(orderDto);
                 
                 log.info("ProductRiOrderResponse >>>>>>> "+productOrderDtoList.toString());
